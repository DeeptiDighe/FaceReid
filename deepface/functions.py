...
def preprocess_face_image(img, target_size=(224, 224), grayscale = False, enforce_detection = True, detector_backend = 'opencv', return_region = False, align = True):
	...
	return resize_face(img, target_size)

def resize_face(img, target_size, grayscale=False, return_region=False):
